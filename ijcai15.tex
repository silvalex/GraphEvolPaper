...
\newcommand{\nonl}{\renewcommand{\nl}{\let\nl\oldnl}}
 \LinesNumbered
	...
	\textbf{3.} Apply mutation, crossover, and elitism to the selected candidates, generating offspring.\\
 ...
 \caption{\footnotesize Steps in the GraphEvol search approach.}
...
\begin{algorithm}
 \setlength\hsize{0.9\linewidth}
 \SetKwInOut{Input}{Input}\SetKwInOut{Output}{Output}
 \SetKwFunction{connectNode}{connectNode}\SetKwFunction{findCands}{findCands}
 \LinesNumbered
 \SetNlSty{}{}{:}
 \Input{$I$, $O$, $relevant$}
 ...
 \While{$end.inputs \not\sqsubseteq currentEndInputs$}{
