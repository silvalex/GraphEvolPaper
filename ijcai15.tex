...
(PSO) \cite{liu2007dynamic,wang2012survey,yin2014hybrid}, fully automated composition using EC is traditionally restricted to techniques employing the traditional Genetic Programming (GP) model \cite{rodriguez2010composition}.
...
the planning graph approach discussed in the composition literature \cite{huang2009effective,deng2013efficient,chen2014qos}.
...
of their input satisfied by the nodes already in the graph (i.e. the \textit{seenNodes}).

Then the building process begins, continuing
...
both graphs but as a consequence contains redundant nodes and edges.
